...
def main():
    ...
    pred_path = os.path.join(repo_root, "eval", "baseline_predictions.jsonl")
    ...
    metrics_out = os.path.join(repo_root, "eval", "baseline_metrics.json")
    buckets_out = os.path.join(repo_root, "eval", "error_buckets.md")
